          ...
          <div className="row">
            <form className="col-lg-6 col-xxl-5">
              ...
              <div className="mb-4 pb-xl-3">
                ...
                <p className="text-n500">Please Enter your Email Address to Start your Online Application</p>
              </div>
              <div className="row g-3 g-xl-4">
                <div className="col-md-6">
                  <label htmlFor="fname" className="d-block text-n500 text-lg fw-medium mb-3">
                    First Name
                  </label>
                  <input type="text" autoComplete="name" placeholder="John" className="solarox-input bg1" />
                </div>
                <div className="col-md-6">
                  <label htmlFor="lname" className="d-block text-n500 text-lg fw-medium mb-3">
                    Last Name
                  </label>
                  <input type="text" autoComplete="additional-name" placeholder="Fisher" className="solarox-input bg1" />
                </div>
                ...
                <div className="col-12">
                  <button className="btn btn-primary w-100 rounded-0 py-2 fw-medium text-bg1 mt-2 mt-xl-3">Sign up</button>
                </div>
              </div>
